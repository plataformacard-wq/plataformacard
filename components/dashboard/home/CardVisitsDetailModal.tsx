            ...
            <div className="md:col-span-6 flex flex-col justify-between space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <Link
                  ...
                  className="flex w-full items-center justify-between rounded-lg bg-blue-600 px-4 py-3 text-xs font-bold text-white shadow-md hover:bg-blue-700 transition-all group"
                  onClick={onClose}
                >
                  <div className="flex items-center gap-2">
                    <QrCode size={16} />
