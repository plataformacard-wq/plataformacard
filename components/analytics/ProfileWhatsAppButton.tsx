...
type ProfileWhatsAppButtonProps = {
  ...
  whatsapp: string;
  isAvailable?: boolean;
  acceptsMessagesWhenClosed?: boolean;
};
...
export default function ProfileWhatsAppButton({
  ...
  if (!isAvailable) {
    if (!acceptsMessagesWhenClosed) {
      return (
        <button 
          disabled
          className="inline-flex w-full items-center justify-center gap-2 rounded-[14px] px-4 py-3.5 text-[15px] font-bold opacity-70 cursor-not-allowed"
          style={{
        ...
        >
          <svg
            className="h-[22px] w-[22px] shrink-0 opacity-40"
            viewBox="0 0 24 24"
            fill="currentColor"
            aria-hidden
          >
    ...
    return (
      <>
        ...
        >
          <svg
            className="h-[22px] w-[22px] shrink-0 opacity-50"
            viewBox="0 0 24 24"
            fill="currentColor"
            aria-hidden
          >
