...
export const updateSettingsSchema = z.object({
  ...
  hero_mockup_url_light: z.string().url().nullable().optional().or(z.literal("")),
...
export const upsertPlanSchema = z.object({
  ...
  annual_discount_type: z.enum(["fixed", "percentage"]).default("fixed"),
  annual_discount_value: z.number().nonnegative().default(0),
