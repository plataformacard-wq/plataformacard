...
export default function CatalogHeader({
  ...
  return (
    <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      {!adminCatalogId ? (
        <div className="flex flex-col gap-3 rounded-2xl border p-6 min-w-[300px] shadow-sm" style={{ background: "var(--dash-surface)", borderColor: "var(--dash-border)" }}>
        ...
        <div className="flex flex-col gap-3 rounded-2xl border p-6 min-w-[300px] shadow-sm bg-purple-500/5 border-purple-500/10" style={{ borderColor: "rgba(168, 85, 247, 0.3)" }}>
