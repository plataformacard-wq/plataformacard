...
INSERT INTO landing_page_plans (
  ...
  null, 
  'dark', 
  to_jsonb(ARRAY['Cartão Digital + Catálogo online', 'Checkout Transacional (Taxa 0%)', 'Domínio Genérico']), 
  'Começar Grátis', 
  '/cadastro', 
  10, 
  true
...
INSERT INTO landing_page_plans (
  ...
  'Recomendado', 
  'green', 
  to_jsonb(ARRAY['Estoque Sincronizado Bling V3', 'CRM e Painel Analítico de Vendas', 'Domínio Próprio e iFrame Integrado', 'Pacote de 3 a 5 Cartões NFC Premium (Grátis na fidelidade)']), 
