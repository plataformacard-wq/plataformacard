...
export default function AccessManager({ currentCode }: AccessManagerProps) {
  ...
  return (
    <div className="rounded-lg border p-6" style={{ background: "var(--dash-surface)", borderColor: "var(--dash-border)" }}>
        ...
        <div>
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 rounded-lg border bg-transparent px-4 py-2 text-sm outline-none focus:border-blue-500"
