    ...
    <>
      ...
      {upcomingHoliday && (
        <motion.div 
          ...
          className="mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-700 p-6 md:p-8 relative"
        >
      ...
      {showNoWhatsappWarning && (
        <motion.div 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="p-6 rounded-2xl border border-red-500/20 bg-red-500/5 backdrop-blur-md flex flex-col md:flex-row items-start md:items-center justify-between gap-4"
        >
          <div className="flex items-center gap-4">
