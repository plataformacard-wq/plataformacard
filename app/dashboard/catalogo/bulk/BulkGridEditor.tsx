...
export default function BulkGridEditor() {
  ...
  return (
    <>
      <div className="md:hidden flex flex-col items-center justify-center p-8 bg-[var(--dash-surface)] border border-[var(--dash-border)] rounded-2xl text-center space-y-4 shadow-sm my-10">
