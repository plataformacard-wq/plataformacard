    ...
    <section className="py-24 bg-transparent relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <h2 className={`text-3xl md:text-5xl font-extrabold text-white tracking-tight ${plusJakarta.className}`}>
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-[44px] left-[12%] right-[12%] h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
              ...
              return (
                <div key={step.id} className="relative flex flex-col items-center text-center group cursor-pointer">
                  ...
                  <div className="relative mb-8 z-10">
                    ...
                    <div className="w-20 h-20 rounded-2xl bg-[#0a0a0a] border border-white/5 shadow-2xl flex items-center justify-center transform group-hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                       {/* Subtle inner glow */}
                       ...
                       <Icon className="w-8 h-8 text-white group-hover:text-[#2CCB68] transition-colors duration-300 relative z-10" strokeWidth={1.5} />
                    </div>
                    {/* Step Number Badge */}
                    <div className="absolute -top-3 -right-3 w-7 h-7 rounded-full bg-[#2CCB68] text-[#0a0a0a] text-xs font-bold flex items-center justify-center border-4 border-[#050505] shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                      {step.id}
                    </div>
                  </div>

                  {/* Text Content */}
                  <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 h-full w-full group-hover:border-[#2CCB68]/30 group-hover:shadow-[0_0_30px_rgba(44,203,104,0.05)] transition-all duration-300">
                    <h3 className={`text-lg font-bold text-white group-hover:text-[#2CCB68] transition-colors duration-300 mb-3 ${plusJakarta.className}`}>
                      {step.title}
                    </h3>
        ...
        <div className="mt-20 flex justify-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-[#0a0a0a] border border-white/5 shadow-xl">
