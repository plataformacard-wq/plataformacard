    ...
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-[32px] border p-8 space-y-6" style={{ background: "var(--dash-surface)", borderColor: "var(--dash-border)" }}>
          ...
          <div className="space-y-4">
             <div className="flex items-center justify-between p-4 rounded-2xl bg-[var(--dash-bg)] border border-[var(--dash-border)]">
                <div className="flex items-center gap-3">
             ...
             <div className="space-y-2">
                ...
                <div className="relative">
                   ...
                   <textarea 
                     ...
                     rows={4}
                     className="w-full pl-12 pr-4 py-4 rounded-2xl border outline-none text-sm transition-all focus:ring-2 focus:ring-primary/20 resize-none"
      ...
      <div className="flex items-center justify-end gap-4 pt-6 border-t" style={{ borderColor: "var(--dash-border)" }}>
         ...
         <button 
           onClick={handleSave}
           disabled={saving}
           className="px-10 py-4 rounded-2xl bg-primary text-white font-black text-sm shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all disabled:opacity-50 flex items-center gap-2"
         >
