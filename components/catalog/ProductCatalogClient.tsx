...
export default function ProductCatalogClient({
  ...
  if (isEmbed && selectedProduct) {
    return (
      ...
      >
        <main className="w-full pt-6 px-3 sm:px-4 pb-12 relative">
  ...
  return (
    ...
    >
      ...
      <main className={`${isEmbed ? 'w-full px-3 sm:px-4 relative' : 'max-w-5xl mx-auto px-4 sm:px-6'} ${isEmbed ? 'pt-4 sm:pt-6' : 'pt-8 sm:pt-12'}`}>
