            ...
            <div className="space-y-4">
              {vendedores
                ...
                <div 
                  ...
                  className="group relative flex flex-col md:flex-row items-center gap-6 p-5 rounded-2xl border transition-all hover:shadow-xl hover:border-primary/30 cursor-pointer"
                ...
                >
                  ...
                  <div className="flex items-center gap-4 w-full md:w-auto md:min-w-[280px] md:max-w-[300px]">
                    <div className="relative flex-shrink-0">
                      {v.avatar_url ? (
                        <img src={v.avatar_url} className="h-20 w-20 rounded-2xl object-cover border-2 border-white shadow-md" />
                      ) : (
