...
export default function ProfileWhatsAppButton({
  ...
  return (
    <a
      ...
      className="inline-flex w-full items-center justify-center gap-2 rounded-[12px] bg-[#25D366] px-4 py-3.5 text-[15px] font-medium text-white transition hover:brightness-95"
    >
      <svg
