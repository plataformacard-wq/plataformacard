...
import { MobileProductCards } from "@/components/dashboard/mobile/MobileProductCards";
...
export default function DashboardClient({ initialData }: { initialData: any }) {
  ...
  return (
    <div className="space-y-6 md:space-y-10 pb-16 md:pb-12">
      {/* 📱 MOBILE VIEW: RENDERIZADO EXCLUSIVAMENTE EM DISPOSITIVOS MÓVEIS (`< md`) */}
      <MobileKpiHeader 
      ...
      {/* 🖥️ DESKTOP VIEW: ESCONDIDO NO MOBILE (`hidden md:block`) */}
