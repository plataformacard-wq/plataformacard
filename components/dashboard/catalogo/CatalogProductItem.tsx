...
type CatalogProductItemProps = {
  product: ProductRow;
  handleOpenEdit: (product: ProductRow) => void;
  getProductImage: (product: ProductRow) => string | null;
  formatPrice: (value: number | null) => string;
  toggleProductStatus: (product: ProductRow, field: 'is_active' | 'is_in_stock') => void;
...
export default function CatalogProductItem({
  ...
  return (
    <Reorder.Item
      ...
      className="group relative flex items-center gap-4 p-4 rounded-[27px] border transition-all hover:shadow-xl hover:border-emerald-500/30 cursor-pointer"
